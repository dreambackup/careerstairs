...
<div class="section-background top-0">
	<div class="container" style="font-size: 18px">
			...
			<?php 
				if($_SESSION['version'] == true)
				{
					echo '<p>but you are already in our list of amazing people!<br/>
			We would love to send you our messages , and thank you for choosing us once again.</p>
			<p>We love to see, that you try to connect with us.<br>
			';
				}
				else{
					echo '<p>for joining our list of amazing people!<br/>
			We would love to send you our messages but first, we need to do one last step.</p>
